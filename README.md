...
Any MoesGo dimmers that use CB2 module should work. Most recently it was tested and confirmed working with <a href="https://www.amazon.com/dp/B0B971DJDF">MOES Dual Dimmer Switch, Double Dimmer Switch for LED Lights, Full Range Dimming, WiFi Smart Light Switch Neutral Wire Required, Single Pole, 300W INC, 75W LED/CFL, Smart Life/Tuya APP Remote Control</a> purchased on Amazon.


## Prepare for flashing
In order to flash esphome on MoesGo, you will need a USB/TTL serial adapter. There is plenty of options on Amazon and Aliexpress. I've been using <a href="https://www.amazon.com/dp/B075N82CDL">this adapter</a> for the last few years with no issues. 
...
<img src="./img/CB2_Connections.png?raw=true" alt="esphome web UI screen" width=100%>
...
VCC -----> VCC on Adapter<br>
GND -----> Ground on Adapter<br>
RX  -----> TX on Adapter<br>
TX  -----> RX on Adapter<br>
